...
# E-mail:                        m.mihailescu.mi@spiruharet.ro
# Descriere:                     Exemplu de creare a unui blockchain folosind Python
# Data crearii:                  10.04.2021
# Data ultimei actualizari:      12.05.2023
# Scop:                          Didactic, Pentru Facultatea de Inginerie si Informatica, Universitatea SPIRU HARET
# Descriere:                     Este doar un simulator - PoC. 
#                                Acest cod ofera doar o privire de ansamblu asupra modului de dezvoltare si de operare. 
#                                Nu este un blockchain real.
